...
class DocumentsContractApi21
{
  ...
  public static Uri[] listFiles(Context paramContext, Uri paramUri)
  {
    ...
    //   29: aload 5
    //   31: iconst_1
    //   32: anewarray 63	java/lang/String
    //   35: dup
    //   36: iconst_0
    //   37: ldc 65
    //   39: aastore
    ...
    //   41: aconst_null
    //   42: aconst_null
    //   43: invokevirtual 71	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   46: astore_3
    //   47: aload_3
    //   48: astore_0
    //   49: aload_3
    ...
    //   74: invokestatic 84	android/provider/DocumentsContract:buildDocumentUriUsingTree	(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    //   77: invokevirtual 88	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   80: pop
    //   81: goto -34 -> 47
    //   84: astore_1
    //   85: aload_0
    //   86: astore_2
    //   87: ldc 12
    //   89: new 90	java/lang/StringBuilder
    //   92: dup
    //   93: invokespecial 91	java/lang/StringBuilder:<init>	()V
    //   96: ldc 93
    //   98: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   101: aload_1
    //   102: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   105: invokevirtual 104	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   108: invokestatic 110	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   111: pop
    //   112: aload_0
    //   113: invokestatic 112	android/support/v4/provider/DocumentsContractApi21:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   116: aload 4
    //   118: aload 4
    //   120: invokevirtual 116	java/util/ArrayList:size	()I
    //   123: anewarray 118	android/net/Uri
    //   126: invokevirtual 122	java/util/ArrayList:toArray	([Ljava/lang/Object;)[Ljava/lang/Object;
    //   129: checkcast 124	[Landroid/net/Uri;
    //   132: areturn
    //   133: aload_3
    //   134: invokestatic 112	android/support/v4/provider/DocumentsContractApi21:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   137: goto -21 -> 116
    //   140: astore_0
    //   141: aload_2
    //   142: invokestatic 112	android/support/v4/provider/DocumentsContractApi21:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   145: aload_0
    //   146: athrow
