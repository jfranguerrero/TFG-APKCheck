...
class DocumentsContractApi19
{
  ...
  public static boolean exists(Context paramContext, Uri paramUri)
  {
    ...
    //   13: aload_1
    //   14: iconst_1
    //   15: anewarray 49	java/lang/String
    //   18: dup
    //   19: iconst_0
    //   20: ldc 78
    //   22: aastore
    ...
    //   24: aconst_null
    //   25: aconst_null
    //   26: invokevirtual 84	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   29: astore_1
    //   30: aload_1
    //   31: astore_0
    //   32: aload_1
    ...
    //   47: istore_3
    //   48: aload_1
    //   49: invokestatic 92	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   52: iload_3
    //   53: ireturn
    //   54: iconst_0
    //   55: istore_3
    ...
    //   61: astore 4
    //   63: ldc 15
    //   65: new 94	java/lang/StringBuilder
    //   68: dup
    ...
    //   77: aload_1
    //   78: invokevirtual 104	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   81: invokevirtual 108	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   84: invokestatic 114	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   87: pop
    //   88: aload_0
    //   89: invokestatic 92	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   92: iconst_0
    //   93: ireturn
    //   94: astore_0
    //   95: aload 4
    //   97: invokestatic 92	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   100: aload_0
    //   101: athrow
