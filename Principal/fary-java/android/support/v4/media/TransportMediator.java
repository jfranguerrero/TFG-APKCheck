  ...
  extends TransportController
{
  ...
  final KeyEvent.Callback mKeyEventCallback = new KeyEvent.Callback()
  {
    public boolean onKeyDown(int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
    {
      if (TransportMediator.isMediaKey(paramAnonymousInt)) {
        return mCallbacks.onMediaButtonDown(paramAnonymousInt, paramAnonymousKeyEvent);
      }
      return false;
    }
    ...
    {
      if (TransportMediator.isMediaKey(paramAnonymousInt)) {
        return mCallbacks.onMediaButtonUp(paramAnonymousInt, paramAnonymousKeyEvent);
      }
      return false;
    }
  };
  ...
  final TransportMediatorCallback mTransportKeyCallback = new TransportMediatorCallback()
  {
    ...
    {
      mCallbacks.onAudioFocusChange(paramAnonymousInt);
    }
    ...
    {
      mCallbacks.onSeekTo(paramAnonymousLong);
    }
  };
  final View mView;
  ...
  {
    return paramKeyEvent.dispatch(mKeyEventCallback, (KeyEvent.DispatcherState)mDispatcherState, this);
  }
