  ...
  implements Parcelable
{
  ...
  public Object getPlaybackState()
  {
    ...
    if (Build.VERSION.SDK_INT >= 22) {}
    for (mStateObj = PlaybackStateCompatApi22.newInstance(mState, mPosition, mBufferedPosition, mSpeed, mActions, mErrorMessage, mUpdateTime, localObject, mActiveItemId, mExtras);; mStateObj = PlaybackStateCompatApi21.newInstance(mState, mPosition, mBufferedPosition, mSpeed, mActions, mErrorMessage, mUpdateTime, localObject, mActiveItemId)) {
      return mStateObj;
    }
  }
