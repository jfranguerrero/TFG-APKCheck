...
public class NotificationCompat
{
    ...
    extends NotificationCompatBase.Action
  {
    ...
    public static final class Builder
    {
      ...
      {
        this(icon, title, actionIntent, new Bundle(mExtras), paramAction.getRemoteInputs(), paramAction.getAllowGeneratedReplies());
      }
    ...
    implements NotificationCompat.NotificationCompatImpl
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      paramBuilderExtender = NotificationCompatBase.add(mNotification, mContext, paramBuilder.resolveTitle(), paramBuilder.resolveText(), mContentIntent, mFullScreenIntent);
      if (mPriority > 0) {
        flags |= 0x80;
      }
      if (mContentView != null) {
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      paramBuilderExtender = NotificationCompatHoneycomb.add(mContext, mNotification, paramBuilder.resolveTitle(), paramBuilder.resolveText(), mContentInfo, mTickerView, mNumber, mContentIntent, mFullScreenIntent, mLargeIcon);
      if (mContentView != null) {
        contentView = mContentView;
      }
      return paramBuilderExtender;
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      return paramBuilderExtender.build(paramBuilder, new NotificationCompatIceCreamSandwich.Builder(mContext, mNotification, paramBuilder.resolveTitle(), paramBuilder.resolveText(), mContentInfo, mTickerView, mNumber, mContentIntent, mFullScreenIntent, mLargeIcon, mProgressMax, mProgress, mProgressIndeterminate));
    }
  }
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      Object localObject = new NotificationCompatJellybean.Builder(mContext, mNotification, paramBuilder.resolveTitle(), paramBuilder.resolveText(), mContentInfo, mTickerView, mNumber, mContentIntent, mFullScreenIntent, mLargeIcon, mProgressMax, mProgress, mProgressIndeterminate, mUseChronometer, mPriority, mSubText, mLocalOnly, mExtras, mGroupKey, mGroupSummary, mSortKey, mContentView, mBigContentView);
      NotificationCompat.addActionsToBuilder((NotificationBuilderWithActions)localObject, mActions);
      NotificationCompat.addStyleToBuilderJellybean((NotificationBuilderWithBuilderAccessor)localObject, mStyle);
      ...
      if (mStyle != null)
      {
        ...
        if (localObject != null) {
          mStyle.addCompatExtras((Bundle)localObject);
        }
      }
      return paramBuilderExtender;
    }
    ...
    extends NotificationCompat.NotificationCompatImplJellybean
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      NotificationCompatKitKat.Builder localBuilder = new NotificationCompatKitKat.Builder(mContext, mNotification, paramBuilder.resolveTitle(), paramBuilder.resolveText(), mContentInfo, mTickerView, mNumber, mContentIntent, mFullScreenIntent, mLargeIcon, mProgressMax, mProgress, mProgressIndeterminate, mShowWhen, mUseChronometer, mPriority, mSubText, mLocalOnly, mPeople, mExtras, mGroupKey, mGroupSummary, mSortKey, mContentView, mBigContentView);
      NotificationCompat.addActionsToBuilder(localBuilder, mActions);
      NotificationCompat.addStyleToBuilderJellybean(localBuilder, mStyle);
