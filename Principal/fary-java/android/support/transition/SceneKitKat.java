  ...
  extends SceneWrapper
{
  ...
  private void updateCurrentScene(View paramView)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	85	0	this	SceneKitKat
    //   0	85	1	paramView	View
    // Exception table:
    //   from	to	target	type
    //   6	37	61	java/lang/NoSuchMethodException
    //   37	60	71	java/lang/IllegalAccessException
    //   37	60	81	java/lang/reflect/InvocationTargetException
  }
  ...
  public void enter()
  {
    if (mLayout != null)
    {
      ...
      localViewGroup.addView(mLayout);
      invokeEnterAction();
  ...
  public void init(ViewGroup paramViewGroup, View paramView)
  {
    ...
    {
      mScene = new Scene(paramViewGroup, (ViewGroup)paramView);
      return;
    }
    mScene = new Scene(paramViewGroup);
    mLayout = paramView;
