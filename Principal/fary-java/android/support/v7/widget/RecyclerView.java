  ...
  implements ScrollingView, NestedScrollingChild
{
  ...
  static void clearNestedRecyclerViewIfNotNested(@NonNull ViewHolder paramViewHolder)
  {
    ...
    if (mNestedRecyclerView != null) {
      localObject = (View)mNestedRecyclerView.get();
    }
  ...
  private boolean didChildRangeChange(int paramInt1, int paramInt2)
  {
    ...
    if ((mMinMaxLayoutPositions[0] != paramInt1) || (mMinMaxLayoutPositions[1] != paramInt2)) {
      bool = true;
    }
    return bool;
  }
    ...
    do
    {
      do
      {
        do
        {
          return true;
          return false;
        } while (((mTempRect.left < mTempRect2.left) || (mTempRect.right <= mTempRect2.left)) && (mTempRect.right < mTempRect2.right));
        return false;
      } while (((mTempRect.bottom > mTempRect2.bottom) || (mTempRect.top >= mTempRect2.bottom)) && (mTempRect.top > mTempRect2.top));
      return false;
    } while (((mTempRect.top < mTempRect2.top) || (mTempRect.bottom <= mTempRect2.top)) && (mTempRect.bottom < mTempRect2.bottom));
    return false;
  }
  ...
  private void recoverFocusFromState()
  {
    ...
    for (;;)
    {
      ...
      if (!isFocused())
      {
        ...
        if ((!mChildHelper.isHidden((View)localObject1)) && (((View)localObject1).getParent() == this) && (((View)localObject1).hasFocus())) {}
      }
      else
      {
        ...
        for (localObject1 = findNextViewToFocus(); localObject1 != null; localObject1 = itemView)
        {
  ...
  public View focusSearch(View paramView, int paramInt)
  {
    ...
    while (isPreferredNextFocus(paramView, (View)localObject, m))
    {
      return localObject;
      label335:
  ...
  public boolean onGenericMotionEvent(MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      if ((!mLayoutFrozen) && ((paramMotionEvent.getSource() & 0x2) != 0) && (paramMotionEvent.getAction() == 8))
      {
        float f1;
        if (mLayout.canScrollVertically())
        {
  ...
  public final class Recycler
  {
    ...
    RecyclerView.ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int paramInt, boolean paramBoolean)
    {
      ...
      while (i < j)
      {
        ...
        if ((!((RecyclerView.ViewHolder)localObject).wasReturnedFromScrap()) && (((RecyclerView.ViewHolder)localObject).getLayoutPosition() == paramInt) && (!((RecyclerView.ViewHolder)localObject).isInvalid()) && ((mState.mInPreLayout) || (!((RecyclerView.ViewHolder)localObject).isRemoved())))
        {
      ...
      if (!paramBoolean)
      {
        localObject = mChildHelper.findHiddenNonRemovedView(paramInt);
        if (localObject != null)
        {
    ...
    void recycleViewHolderInternal(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      bool = RecyclerView.ViewHolder.access$700(paramViewHolder);
      int i;
      int j;
      int m;
      int k;
      ...
      for (;;)
      {
        ...
        {
          k = i + 1;
          mCachedViews.add(k, paramViewHolder);
          i = 1;
          j = i;
          k = m;
          if (i == 0)
    ...
    RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int paramInt, boolean paramBoolean, long paramLong)
    {
      ...
      for (;;)
      {
        ...
        m = mAdapterHelper.findPositionOffset(paramInt);
        if ((m >= 0) && (m < mAdapter.getItemCount())) {
          break label339;
        }
        throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + paramInt + "(offset:" + m + ")." + "state:" + mState.getItemCount());
        j = 0;
        break;
        label313:
      ...
      if (mAdapter.hasStableIds())
      {
        localObject1 = getScrapOrCachedViewForId(mAdapter.getItemId(m), k, paramBoolean);
        localObject2 = localObject1;
        j = i;
        if (localObject1 != null)
        {
      ...
      if (localObject2 == null)
      {
        ...
        {
          View localView = mViewCacheExtension.getViewForPositionAndType(this, paramInt, k);
          localObject1 = localObject2;
          if (localView != null)
          {
      ...
      {
        long l1 = getNanoTime();
        if ((paramLong != Long.MAX_VALUE) && (!mRecyclerPool.willCreateInTime(k, l1, paramLong))) {
          return null;
        }
        localObject2 = mAdapter.createViewHolder(RecyclerView.this, k);
        if (RecyclerView.ALLOW_THREAD_GAP_WORK)
        {
    ...
    {
      if (mLayout != null) {}
      for (int i = mLayout.mPrefetchMaxCountObserved;; i = 0)
      {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      for (;;)
      {
        ...
        postOnAnimation();
        if (mGapWorker != null) {
          mGapWorker.postFromTraversal(RecyclerView.this, i4, i5);
        }
      }
    }
