  ...
  extends LinearLayoutCompat
{
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (localObject1 != null)
    {
      ...
      j = ViewCompat.combineMeasuredStates(0, ViewCompat.getMeasuredState(localObject1));
    }
    i = 0;
    int i2 = 0;
    int m = j;
    ...
    if (localObject3 != null)
    {
      ...
      n = k + i;
      m = ViewCompat.combineMeasuredStates(j, ViewCompat.getMeasuredState(localObject3));
    }
    int i1 = 0;
    j = m;
    k = n;
    ...
    for (j = 0;; j = View.MeasureSpec.makeMeasureSpec(Math.max(0, i3 - n), i7))
    {
      ...
      k = n + i1;
      j = ViewCompat.combineMeasuredStates(m, ViewCompat.getMeasuredState(localObject2));
      i3 -= k;
      m = j;
      int i4 = i3;
      n = k;
      if (localObject3 != null)
      {
        ...
        i = ViewCompat.combineMeasuredStates(j, ViewCompat.getMeasuredState(localObject3));
        i4 = m;
        m = i;
      }
      j = m;
