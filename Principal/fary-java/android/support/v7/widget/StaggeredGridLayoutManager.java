  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  private int computeScrollExtent(RecyclerView.State paramState)
  {
    ...
    {
      return ScrollbarHelper.computeScrollExtent(paramState, localOrientationHelper, localView, findFirstVisibleItemClosestToEnd(bool1), this, mSmoothScrollbarEnabled);
      bool1 = false;
      break;
    }
  }
  ...
  private int computeScrollOffset(RecyclerView.State paramState)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      return ScrollbarHelper.computeScrollOffset(paramState, localOrientationHelper, localView, findFirstVisibleItemClosestToEnd(bool1), this, mSmoothScrollbarEnabled, mShouldReverseLayout);
      bool1 = false;
      break;
    }
  }
  ...
  private int computeScrollRange(RecyclerView.State paramState)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      return ScrollbarHelper.computeScrollRange(paramState, localOrientationHelper, localView, findFirstVisibleItemClosestToEnd(bool1), this, mSmoothScrollbarEnabled);
      bool1 = false;
      break;
    }
  }
  ...
  public void collectAdjacentPrefetchPositions(int paramInt1, int paramInt2, RecyclerView.State paramState, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    for (;;)
    {
      ...
      paramInt1 = 0;
      Object localObject;
      if (paramInt1 < mSpanCount)
      {
        localObject = mPrefetchDistances;
        if (mLayoutState.mItemDirection == -1) {}
        for (paramInt2 = mLayoutState.mStartLine - mSpans[paramInt1].getStartLine(mLayoutState.mStartLine);; paramInt2 = mSpans[paramInt1].getEndLine(mLayoutState.mEndLine) - mLayoutState.mEndLine)
        {
      ...
      paramInt1 = 0;
      while ((paramInt1 < mSpanCount) && (mLayoutState.hasMore(paramState)))
      {
        paramLayoutPrefetchRegistry.addPosition(mLayoutState.mCurrentPosition, mPrefetchDistances[paramInt1]);
