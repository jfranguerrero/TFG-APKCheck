...
class NotificationCompatImplBase
{
  ...
  public static int calculateTopPadding(Context paramContext)
  {
    ...
    float f = (constrain(getResourcesgetConfigurationfontScale, 1.0F, 1.3F) - 1.0F) / 0.29999995F;
  ...
  {
    bigContentView = generateMediaBigView(paramContext, paramCharSequence1, paramCharSequence2, paramCharSequence3, paramInt1, paramBitmap, paramCharSequence4, paramBoolean1, paramLong, paramInt2, paramInt3, paramList, paramBoolean2, paramPendingIntent, paramBoolean3);
    if (paramBoolean2) {
      flags |= 0x2;
    }
  }
