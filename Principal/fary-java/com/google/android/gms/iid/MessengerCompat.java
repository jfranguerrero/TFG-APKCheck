  ...
  implements ReflectedParcelable
{
  ...
  public MessengerCompat(Handler paramHandler)
  {
    ...
    {
      zzbho = new Messenger(paramHandler);
      return;
    }
    zzbhp = new zza(paramHandler);
  }
  ...
  public MessengerCompat(IBinder paramIBinder)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      zzbho = new Messenger(paramIBinder);
      return;
    }
    zzbhp = zzb.zza.zzcZ(paramIBinder);
  }
    ...
    throws RemoteException
  {
    if (zzbho != null)
    {
      zzbho.send(paramMessage);
      return;
    }
    zzbhp.send(paramMessage);
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    if (zzbho != null)
    {
      paramParcel.writeStrongBinder(zzbho.getBinder());
      return;
    }
    paramParcel.writeStrongBinder(zzbhp.asBinder());
  }
