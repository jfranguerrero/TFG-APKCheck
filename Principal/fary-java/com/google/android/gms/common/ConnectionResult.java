  ...
  extends zza
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((zzauz == zzauz) && (zzaa.equal(mPendingIntent, mPendingIntent)) && (zzaa.equal(zzawY, zzawY)));
    return false;
  }
  ...
  public int hashCode()
  {
    return zzaa.hashCode(new Object[] { Integer.valueOf(zzauz), mPendingIntent, zzawY });
  }
  ...
  {
    return zzaa.zzv(this).zzg("statusCode", getStatusString(zzauz)).zzg("resolution", mPendingIntent).zzg("message", zzawY).toString();
  }
