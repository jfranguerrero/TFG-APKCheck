...
public abstract interface zzld
  extends IInterface
{
  public abstract boolean isValidPurchase(String paramString)
    throws RemoteException;
  
  public abstract void zza(zzlc paramZzlc)
    throws RemoteException;
    ...
    implements zzld
  {
    ...
    public static zzld zzab(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzld))) {
        return (zzld)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      paramParcel1.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
      zza(zzlc.zza.zzaa(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zzld
    {
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/zzld$zza$zza:zzrp	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload 4
        //   32: aload 5
        //   34: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzld$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_2
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
