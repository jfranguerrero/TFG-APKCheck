...
public final class zzbum
{
  ...
  public void zzd(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    throws IOException
  {
    if (zzcrW.remaining() >= paramInt2)
    {
      zzcrW.put(paramArrayOfByte, paramInt1, paramInt2);
      return;
    }
    throw new zza(zzcrW.position(), zzcrW.limit());
  }
    ...
    throws IOException
  {
    ...
    {
      zza localZza = new zza(zzcrW.position(), zzcrW.limit());
      localZza.initCause(paramString);
      throw localZza;
    }
    zzcrW.position(j + i);
    zza(paramString, zzcrW);
