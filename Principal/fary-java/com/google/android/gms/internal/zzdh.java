...
public class zzdh
{
  ...
  static String zza(String[] paramArrayOfString, int paramInt1, int paramInt2)
  {
    ...
    {
      zzpe.e("Unable to construct shingle");
      return "";
    }
  ...
  static void zza(int paramInt1, long paramLong, String paramString, int paramInt2, PriorityQueue<zza> paramPriorityQueue)
  {
    ...
    if ((paramPriorityQueue.size() == paramInt1) && ((peekzzyk > zzyk) || (peekvalue > value))) {}
    do
    {
      do
      {
  ...
  public static void zza(String[] paramArrayOfString, int paramInt1, int paramInt2, PriorityQueue<zza> paramPriorityQueue)
  {
    ...
    for (;;)
    {
      ...
      {
        l1 = zza(zzdf.zzH(paramArrayOfString[(i - 1)]), zzdf.zzH(paramArrayOfString[(i + paramInt2 - 1)]), l1, l2, 16785407L);
  ...
  {
    long l = (zzdf.zzH(paramArrayOfString[paramInt1]) + 2147483647L) % 1073807359L;
    int i = paramInt1 + 1;
    while (i < paramInt1 + paramInt2)
    {
      l = (l * 16785407L % 1073807359L + (zzdf.zzH(paramArrayOfString[i]) + 2147483647L) % 1073807359L) % 1073807359L;
      i += 1;
    }
    return l;
  }
