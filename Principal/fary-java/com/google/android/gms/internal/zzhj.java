...
public abstract interface zzhj
  extends IInterface
{
  public abstract void zza(zzhd paramZzhd)
    ...
    implements zzhj
  {
    ...
    public static zzhj zzH(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzhj))) {
        return (zzhj)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzhd.zza.zzE(paramParcel1.readStrongBinder()));
      ...
      implements zzhj
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzhj$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
