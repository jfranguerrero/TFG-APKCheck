  ...
  implements zzy
{
    ...
    throws IOException
  {
    ...
    if (("https".equals(paramURL.getProtocol())) && (zzaE != null)) {
      ((HttpsURLConnection)localHttpURLConnection).setSSLSocketFactory(zzaE);
    }
    ...
    throws IOException, zza
  {
    ...
    if (zzaD != null)
    {
      str = zzaD.zzh((String)localObject);
      paramMap = str;
      if (str == null)
      {
