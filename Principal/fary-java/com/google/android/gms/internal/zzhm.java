...
public abstract interface zzhm
  extends IInterface
{
  public abstract void zza(zzhh paramZzhh)
    ...
    implements zzhm
  {
    ...
    public static zzhm zzK(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zza(zzhh.zza.zzG(paramParcel1.readStrongBinder()));
      ...
      implements zzhm
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzhm$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
