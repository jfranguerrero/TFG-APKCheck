...
public final class zzef
{
  ...
  public zzef(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (zzzr = zzK(paramAttributeSet);; zzzr = zzK(str))
    {
      zztq = paramContext.getString(R.styleable.AdsAttrs_adUnitId);
      if (!TextUtils.isEmpty(zztq)) {
        return;
      }
  ...
  private static AdSize[] zzK(String paramString)
  {
  ...
  public AdSize[] zzm(boolean paramBoolean)
  {
    if ((!paramBoolean) && (zzzr.length != 1)) {
