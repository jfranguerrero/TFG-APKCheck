...
public abstract interface zzhk
  extends IInterface
{
  public abstract void zza(zzhf paramZzhf)
    ...
    implements zzhk
  {
    ...
    public static zzhk zzI(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzhk))) {
        return (zzhk)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzhf.zza.zzF(paramParcel1.readStrongBinder()));
      ...
      implements zzhk
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzhk$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
