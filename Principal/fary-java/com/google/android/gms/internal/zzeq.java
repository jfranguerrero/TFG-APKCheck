...
public abstract interface zzeq
  extends IInterface
{
  public abstract IBinder zza(zzd paramZzd, zzec paramZzec, String paramString, zzjs paramZzjs, int paramInt)
    throws RemoteException;
  
  public abstract IBinder zza(zzd paramZzd, zzec paramZzec, String paramString, zzjs paramZzjs, int paramInt1, int paramInt2)
    throws RemoteException;
  ...
  public static abstract class zza
    ...
    implements zzeq
  {
    public static zzeq zzr(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        if (paramParcel1.readInt() != 0) {
          localObject = (zzec)zzec.CREATOR.createFromParcel(paramParcel1);
        }
        paramParcel1 = zza(localZzd1, (zzec)localObject, paramParcel1.readString(), zzjs.zza.zzM(paramParcel1.readStrongBinder()), paramParcel1.readInt());
      ...
      paramParcel1 = zza(localZzd2, (zzec)localObject, paramParcel1.readString(), zzjs.zza.zzM(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
      paramParcel2.writeNoException();
      paramParcel2.writeStrongBinder(paramParcel1);
      return true;
    }
      ...
      implements zzeq
    {
      ...
      /* Error */
      public IBinder zza(zzd paramZzd, zzec paramZzec, String paramString, zzjs paramZzjs, int paramInt)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
        ...
        //   48: aload 7
        //   50: iconst_0
        //   51: invokevirtual 53	com/google/android/gms/internal/zzec:writeToParcel	(Landroid/os/Parcel;I)V
        //   54: aload 7
        //   56: aload_3
        ...
        //   89: aload_0
        //   90: getfield 18	com/google/android/gms/internal/zzeq$zza$zza:zzrp	Landroid/os/IBinder;
        //   93: iconst_1
        //   94: aload 7
        //   96: aload 8
        //   98: iconst_0
        ...
        //   0	155	2	paramZzec	zzec
        //   0	155	3	paramString	String
        //   0	155	4	paramZzjs	zzjs
      ...
      /* Error */
      public IBinder zza(zzd paramZzd, zzec paramZzec, String paramString, zzjs paramZzjs, int paramInt1, int paramInt2)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
        ...
        //   96: aload_0
        //   97: getfield 18	com/google/android/gms/internal/zzeq$zza$zza:zzrp	Landroid/os/IBinder;
        //   100: iconst_2
        //   101: aload 8
        //   103: aload 9
        //   105: iconst_0
        ...
        //   0	162	2	paramZzec	zzec
        //   0	162	3	paramString	String
        //   0	162	4	paramZzjs	zzjs
