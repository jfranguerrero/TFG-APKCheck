...
public abstract interface zzlc
  extends IInterface
{
    ...
    implements zzlc
  {
    ...
    public static zzlc zzaa(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzlc))) {
        return (zzlc)localIInterface;
      }
      ...
      implements zzlc
    {
        ...
        throws RemoteException
      {
        ...
        //   14: aload_0
        //   15: getfield 18	com/google/android/gms/internal/zzlc$zza$zza:zzrp	Landroid/os/IBinder;
        //   18: iconst_2
        //   19: aload_2
        //   20: aload_3
        //   21: iconst_0
