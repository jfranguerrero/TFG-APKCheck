...
public class zzzl
{
  private static long zzH(long paramLong)
  {
  ...
  private static long zza(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    while (i < j)
    {
      l = zzH(zzb(paramArrayOfByte, i) * -4132994306676758123L);
      i += 8;
    ...
    return zzH(zzH(l) * -4132994306676758123L);
  }
  ...
  public static long zzn(byte[] paramArrayOfByte)
  {
  ...
  private static long zzo(byte[] paramArrayOfByte)
  {
    ...
    return zzH(zzH((Long.rotateRight(l8, 31) + l5 + (l6 + l7) + (l1 + l2)) * -4288712594273399085L + (l8 + l4 + l3) * -6505348102511208375L) * -6505348102511208375L + l3) * -4288712594273399085L;
  }
  
  private static long zzp(byte[] paramArrayOfByte)
  {
    int i = paramArrayOfByte.length;
    ...
    l1 = (l1 ^ 0xA5B85C5E198ED849) + zzH(arrayOfLong1[1]) * -8261664234251669945L;
    ...
    for (;;)
    {
      ...
      i -= 64;
      if (i == 0) {
        return zzc(zzc(arrayOfLong1[0], arrayOfLong2[0]) + zzH(l2) * -8261664234251669945L + l3, zzc(arrayOfLong1[1], arrayOfLong2[1]) + l4);
      }
      l1 = l3;
      l3 = l4;
    }
