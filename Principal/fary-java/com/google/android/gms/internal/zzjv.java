...
public abstract interface zzjv
  extends IInterface
{
    ...
    implements zzjv
  {
    ...
    public static zzjv zzP(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzjv))) {
        return (zzjv)localIInterface;
      }
