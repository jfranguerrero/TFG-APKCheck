  ...
  implements Parcelable.Creator<zzawc>
{
  ...
  static void zza(zzawc paramZzawc, Parcel paramParcel, int paramInt)
  {
    ...
    zzc.zza(paramParcel, 2, name, false);
    zzc.zza(paramParcel, 3, zzbzt);
    zzc.zza(paramParcel, 4, zzbgG);
    zzc.zza(paramParcel, 5, zzbgI);
    zzc.zza(paramParcel, 6, zzaFy, false);
    zzc.zza(paramParcel, 7, zzbzu, false);
    zzc.zzc(paramParcel, 8, zzbzv);
    zzc.zzc(paramParcel, 9, zzbzw);
