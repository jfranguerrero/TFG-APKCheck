...
public abstract interface zzgj
  extends IInterface
{
  public abstract void zza(zzgi paramZzgi)
    ...
    implements zzgj
  {
    ...
    public static zzgj zzA(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzgj))) {
        return (zzgj)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzgi.zza.zzz(paramParcel1.readStrongBinder()));
      ...
      implements zzgj
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzgj$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
