...
public abstract interface zzhl
  extends IInterface
{
  public abstract void zza(zzhh paramZzhh, String paramString)
    ...
    implements zzhl
  {
    ...
    public static zzhl zzJ(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzhl))) {
        return (zzhl)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzhh.zza.zzG(paramParcel1.readStrongBinder()), paramParcel1.readString());
      ...
      implements zzhl
    {
        ...
        throws RemoteException
      {
        ...
        //   36: aload_0
        //   37: getfield 18	com/google/android/gms/internal/zzhl$zza$zza:zzrp	Landroid/os/IBinder;
        //   40: iconst_1
        //   41: aload_3
        //   42: aload 4
        //   44: iconst_0
