...
public abstract interface zzns
  extends IInterface
{
  public abstract IBinder zza(zzd paramZzd, zzjs paramZzjs, int paramInt)
  ...
  public static abstract class zza
    ...
    implements zzns
  {
    public static zzns zzai(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      paramParcel1 = zza(zzd.zza.zzcd(paramParcel1.readStrongBinder()), zzjs.zza.zzM(paramParcel1.readStrongBinder()), paramParcel1.readInt());
      ...
      implements zzns
    {
      ...
      /* Error */
      public IBinder zza(zzd paramZzd, zzjs paramZzjs, int paramInt)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
        ...
        //   63: aload_0
        //   64: getfield 18	com/google/android/gms/internal/zzns$zza$zza:zzrp	Landroid/os/IBinder;
        //   67: iconst_1
        //   68: aload 5
        //   70: aload 6
        //   72: iconst_0
