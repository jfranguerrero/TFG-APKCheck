...
public final class AdSize
{
  ...
  {
    return zzaI.getHeight();
  }
  
  public int getHeightInPixels(Context paramContext)
  {
    return zzaI.getHeightInPixels(paramContext);
  }
  
  public int getWidth()
  {
    return zzaI.getWidth();
  }
  
  public int getWidthInPixels(Context paramContext)
  {
    return zzaI.getWidthInPixels(paramContext);
  }
  
  public int hashCode()
  {
    return zzaI.hashCode();
  }
  
  public boolean isAutoHeight()
  {
    return zzaI.isAutoHeight();
  }
